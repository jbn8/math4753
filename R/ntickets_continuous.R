...
#' @param gamma probability of the plane being overbooked
#' @param p probability of a "show"
#'
#' @return a plot of the objective function vs n showing the optimized tickets sold
#' @export
#'
#' @examples  ntickets_continuous(N=200, gamma= 0.02, p=0.95)
